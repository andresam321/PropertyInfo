...
const LaPeraContactForm = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    axios.post("http://localhost:8000/api/laPera",{
      firstName,
      lastName,
      phoneNumber,
      email,
        ...
        <form onSubmit={submitHandler}>
          ...
          <div className="col-md-4 mb-4 left" >
            ...
            <select value ={propertyApplyingFor} name="propertyApplyingFor" className='form-control' onChange={(e)=> setPropertyApplyingFor(e.target.value)}>
                ...
                <option value="34 La Pera Ct, Sacramento, CA 95823">34 La Pera Ct, Sacramento, CA 95823</option>
            </select>
            {
...
export default LaPeraContactForm